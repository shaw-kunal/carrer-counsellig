...
export const FlagSwipper = () => {
  return (
    <div className="container px-2 sm:px-4 my-20 ">
      <h2 className="mb-10 text-center font-bold text-slate-900 text-[30px] lg:text-[40px] ">
        Your Next Step Toward Global Learning
      </h2>
          ...
          {topStudyAbroadCountries.map((item, i) => (
            <SwiperSlide key={item.title}>
              ...
              >
                ...
                <span
                  className={` text-md lg:text-lg  hidden md:block  text-slate-500 `}
                >
                  {' '}
                  {item.title}
                </span>
