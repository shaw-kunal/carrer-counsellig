      ...
      <div className="p-2 w-full md:w-4/5 mx-auto">
        ...
        <div className="flex justify-between h-48">
          ...
          <div className="w-[150px] h-[150px] relative hidden md:block">
            <Image  fill className="rounded-lg" objectFit="cover"   src={'/free-counselling.jpg'} alt="free-counselling"/>
          </div>
          </div>
        </div>
        {/* EXPERIENCE LIST ITEM */}
        <div className="flex justify-between h-48">
          ...
          <div className="w-[150px] h-[150px] relative ml-auto hidden md:block">
            <Image  fill className="rounded-lg" objectFit="cover"   src={'/passport.jpg'} alt="free-counselling"/>
          </div>
          </div>
          {/* CENTER */}
          <div className="w-1/5 flex justify-center">
        ...
        <div className="flex justify-between h-48">
          ...
          <div className="w-2/5 ">
          <div className="w-[150px] h-[150px] relative hidden md:block">
            <Image  fill className="rounded-lg" objectFit="cover"   src={'/university.jpg'} alt="free-counselling"/>
          </div>
          </div>
        </div>
        {/* EXPERIENCE LIST ITEM */}
        <div className="flex justify-between h-48">
          ...
          <div className="w-2/5 ">
          <div className="w-[150px] h-[150px] relative ml-auto hidden md:block">
            <Image  fill className="rounded-lg" objectFit="cover"   src={'/preDeparture.jpg'} alt="free-counselling"/>
          </div>
          </div>
          {/* CENTER */}
          <div className="w-1/5 flex justify-center">
